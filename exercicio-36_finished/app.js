...
// console.log(...myName.replace("j", "J"));
...
timestamps.forEach((o) => (objTimestamps[o.date] = o.value));

// console.log(objTimestamps );
...
// forEach(oddNumbers, (number, i, arr) => {
//   console.log(`${number} é o ${++i}º item do array
//   ${arr}`);
//   accumulator += number;
// });
...
function changeSlide() {
  ...
  slides[indice].classList.add("carousel__item--visible");
}
