...
person.greeting = function () {
  return `Oi. Eu sou ${this.gender === "Feminino" ? "a" : "o"} ${this.name} ${
    this.lastName
  }, tenho ${this.age} ${this.age < 2 ? "ano" : "anos"}, ${this.height} ${
    this.height < 2 ? "metro" : "metros"
  } de altura, peso ${this.weight} quilos e, só hoje, eu já caminhei ${
    this.walkedMeters
  } metros. `;
};
...
function isFalsy(value) {
  ...
  return ` ${value} é ${falsy.includes(value) ? "Falsy" : "Truthy"}`;
}
...
// console.log(isFalsy("anything"));
// console.log(isFalsy(5));
// console.log(isFalsy(new Array()));
// console.log(isFalsy({}));
// console.log(isFalsy([]));
// console.log(isFalsy(JSON));
...
console.log(getBook("Clean Code"));
console.log(getBook("Code"));
