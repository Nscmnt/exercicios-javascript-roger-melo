...
// Sem a utlização da template string

const foodsInfo =
  'Até aqui, o  array "brazilianFoods" possui ' +
  brazilianFoods.length +
  " itens: " +
  brazilianFoods[0] +
  ", " +
  brazilianFoods[1] +
...
let dogNames = [].concat(maleDogNames).concat(femaleDogNames);
// console.log(dogNames);

// dogNames = [...maleDogNames, ...femaleDogNames]; - with Spread
// console.log(dogNames);
...
const initials = `${dogNames.reduce(
  (acc, name) => (acc += name.substr(0, 1)),
  ""
)}`;
