...
const lastNumberEven = evenNumbers[evenNumbers.length - 1];
const lastNumberOdd = oddNumbers[oddNumbers.length - 1];

console.log(
  `Numeros ímpares: ${oddNumbers.slice(
    0,
    oddNumbers.length - 1
  )} e ${lastNumberOdd}. Números pares: ${evenNumbers.slice(
    0,
